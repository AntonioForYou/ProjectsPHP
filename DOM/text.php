<?php
    require_once $_SERVER['DOCUMENT_ROOT'] . '/ProjectsPHP/core/logic_text.php';
?>
...
<div class="container col-md-5 mt-4">
    <form action="text.php" method="post" class="test-content">
        <div class="form-group">
            <label for="text">Введите текст</label>
            <textarea name="text" id="text" cols="30" rows="10" class="form-control"><?php if(isset($_POST['text'])) echo $_POST['text'];?></textarea>
        </div>
