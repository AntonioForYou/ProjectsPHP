<?php
require_once $_SERVER['DOCUMENT_ROOT'] . '/ProjectsPHP/core/logic_add.php';
?>
<!doctype html>
<html lang="en">
<head>
...
<div class="container">
    ...
    <form class="row row-cols-lg-auto g-3 align-items-center " name="addStudent" method="post" action="add.php" enctype="multipart/form-data">
        ...
        <div class="col-4 m-2"><button name="submit" class="col-4 btn btn-primary" type="submit">Отправить</button>	</div>
    </form>
</div>
<div class="container">
